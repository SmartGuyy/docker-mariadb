...
COPY /var/lib/jenkins/workspace/Prestashop_Selenium_Tests/docker-mariadb/prebuildfs /
...
COPY /var/lib/jenkins/workspace/Prestashop_Selenium_Tests/docker-mariadb/rootfs /
